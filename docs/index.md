...
土屋俊介 (@shunsock) はデータ領域に強みを持つソフトウェアエンジニアです。
...
ファインディ株式会社の正社員として、Modern Data Stackを利用したデータ基盤の構築およびプラットフォームエンジニアリングによるインフラストラクチャの効率化を行っております。

個人事業主として、機械学習・インフラストラクチャ・ウェブアプリケーションなど幅広いソリューションを提供しております。

### 今後の見通し

長期的には、企業のデータ活用を技術で押し進めるCDO (Chief Data Officer) を目指しています。具体的にはDAMAホイールの実践による企業価値への貢献に興味があります。

直近では、対外的なプロダクト開発に興味を持っています。具体的には、データを使って企業価値に直接貢献するデータプロダクトの開発に興味を持っています。
